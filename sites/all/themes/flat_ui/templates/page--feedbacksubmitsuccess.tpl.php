...
<div id="wrap" style="min-height: 480px; padding-top: 20px;">
    ...
    <div style="float: left; margin-left: 50px; margin-top: 120px;"><img src="<?php echo $theme_path ?>/assets/images/submitsuccess.png" /></div>
    <div style="float: left; margin-top: 150px; margin-left: 30px; font-size: 24px;">Your assessment has been submitted successfully, thank you.</div>
    <?php global $user;?>
    <?php if ($user->uid != 0): ?>
