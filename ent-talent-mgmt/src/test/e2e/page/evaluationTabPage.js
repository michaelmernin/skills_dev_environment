...
var EvaluationTabPage = function () {
  this.ui = {
    ...
    closeBtn: element(by.name('evalForm')).element(by.cssContainingText('button', 'Close')),
  ...
  this.getToggleQuestionnaire = function(toggleName){
    ...
    questions = toggleBtn.element(by.xpath('ancestor::md-list-item')).all(by.xpath('following-sibling::md-list-item'));
    
    return questions;
    
  };
  
/*   this.clickQuestion = function(toggleNum, questionNum){
         
    var btnContainer = element(by.css('md-tab-content:nth-child(4)')).element(by.css('md-list > div:nth-child('+toggleNum+')'));
     
     var itemNum = questionNum+1;
     var questionBtn = btnContainer.element(by.css('md-list-item:nth-child('+itemNum+')')).element(by.tagName('button'));
