...
public class TasksService {
	...
	/**
	 * Retrieve the tasks associated with a specific user. This can be considered as
	 * retrieving the to-do list of the user
	 ...
	 * @param activitiTaskId The String id of the task to be retrieved from the engine
	 * @return The String id of the Task in the Activiti engine
	 */
	public String getTask(String activitiTaskId){
		Task task = taskSvc.createTaskQuery().taskId(activitiTaskId).singleResult();
	 ...
	 * continue. 
	 * @param activitiTaskId the String id of the Task in the activiti engine
	 * @param result The String result of the task that will be used to 
	 * continue in the workflow process.
	 */
	 ...
	 * @param processInstanceId The String process instance id as marked in
	 * the activiti engine
	 * @return List of String objects with the ids of the tasks
	 */
	public List<String> getProcessTasks(String processInstanceId){
		List<Task> tasks = taskSvc.createTaskQuery().processInstanceId(processInstanceId).list();
